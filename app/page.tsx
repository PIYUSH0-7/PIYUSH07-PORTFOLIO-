  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans selection:bg-purple-100 dark:selection:bg-purple-900 selection:text-purple-900 dark:selection:text-purple-50 pb-24 transition-colors duration-300 overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-0 right-1/4 w-96 h-96 bg-yellow-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob dark:bg-yellow-900/20 dark:mix-blend-screen"
          style={{ animationDelay: '2s' }}
        ></div>
        <div
          className="absolute -bottom-32 left-1/3 w-96 h-96 bg-pink-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob dark:bg-pink-900/20 dark:mix-blend-screen"
