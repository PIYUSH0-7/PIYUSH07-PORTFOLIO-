...
import { Home, FolderGit2, Github, Linkedin, Moon, Sun, FileDown, FileText, Zap, Download } from 'lucide-react';
...
const Navbar: React.FC<NavbarProps> = ({ isDarkMode, toggleTheme, language, toggleLanguage }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1 px-2 py-2 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 rounded-full shadow-2xl shadow-zinc-200/50 dark:shadow-none">
        <button
        ...
        <div className="relative" ref={menuRef}>
          ...
          {showResumeMenu && (
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-64 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center transition-colors border border-zinc-200 dark:border-zinc-700">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-purple-50 dark:bg-purple-900/20 flex items-center justify-center text-purple-600 dark:text-purple-400 group-hover:bg-purple-100">
                  <Zap size={18} />
                </div>
                <div className="flex flex-col">
                  <span className="text-sm font-semibold">Live Portfolio CV</span>
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center text-xs font-bold text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-full transition-all active:scale-95 ml-2"
